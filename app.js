...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderNotifications() {
        ...
        [...notifications].reverse().forEach(notif => {
            ...
            item.innerHTML = `
                <div class="notif-icon"><i class="fa-solid ${notif.icon}" style="color: ${notif.color}"></i></div>
        ...
        gateData.forEach(gate => {
            ...
            card.innerHTML = `
                <div class="card-header">
                    ...
                    <div class="card-icon gate-icon"><i class="fa-solid fa-door-open"></i></div>
                </div>
        ...
        foodData.forEach(stall => {
            ...
            card.innerHTML = `
                <div class="card-header">
                    ...
                    <div class="card-icon food-icon"><i class="fa-solid fa-utensils"></i></div>
                </div>
        ...
        agentsLogic.forEach(agent => {
            ...
            card.innerHTML = `
                ...
                <div class="agent-status">
                    <div class="dot ${statusClass}"></div>
                    <span style="color: ${status === 'Alert' ? 'var(--neon-red)' : 'var(--text-secondary)'}">${agent.status}</span>
                </div>
            `;
